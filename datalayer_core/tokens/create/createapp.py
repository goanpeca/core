...
from datalayer_core.tokens.utils import display_tokens
...
class TokensCreateApp(DatalayerCLIBaseApp, TokensCreateMixin):
    ...
    description = """
      ...
      Usage:
        datalayer secrets create NAME DESCRIPTION DATE
        datalayer secrets create NAME DESCRIPTION DATE [--variant VARIANT]
    """
